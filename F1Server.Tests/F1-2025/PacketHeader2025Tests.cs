...
/// </summary>
[TestClass]
public class PacketHeader2025Tests
{
    ...
    /// </summary>
    [TestMethod]
    public void PacketHeaderCheckFile2025IsExisting()
    {
        var isExists = File.Exists(@"SampleData/F1-2025-HeaderCheck.packet");
    ...
    {
        var packetContent = File.ReadAllBytes(@"SampleData/F1-2025-HeaderCheck.packet");
    ...
    /// </summary>
    [TestMethod]
    public void PacketHeaderCheckSessionUniqueId2025ReturnsExpectedNumber()
    {
        var packetContent = File.ReadAllBytes(@"SampleData/F1-2025-HeaderCheck.packet");
    ...
    /// </summary>
    [TestMethod]
    public void PacketHeaderCheckPacketType2025IsEventPacket()
    {
        var packetContent = File.ReadAllBytes(@"SampleData/F1-2025-HeaderCheck.packet");
