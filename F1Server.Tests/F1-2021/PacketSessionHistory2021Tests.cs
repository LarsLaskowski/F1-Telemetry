...
/// </summary>
[TestClass]
public class PacketSessionHistory2021Tests
{
    #region Fields
    ...
    {
        var is2021File = File.Exists(@"SampleData/F1-2021-SessionHistory.packet");

        if (is2021File)
        {
            _packetAnalyzer = new PacketAnalyzer();

            _packetContent = File.ReadAllBytes(@"SampleData/F1-2021-SessionHistory.packet");
        ...
        {
            Assert.IsTrue(is2021File, "File F1-2021-SessionHistory.packet is missing!");
        }
    }
