...
/// </summary>
[TestClass]
public class PacketFinalClassification2021Tests
{
    #region Fields
    ...
    {
        var is2021File = File.Exists(@"SampleData/F1-2021-FinalClassification.packet");

        if (is2021File)
        {
            _packetAnalyzer = new PacketAnalyzer();

            _packetContent = File.ReadAllBytes(@"SampleData/F1-2021-FinalClassification.packet");
        ...
        {
            Assert.IsTrue(is2021File, "File F1-2021-FinalClassification.packet is missing!");
        }
    }
    ...
    /// </summary>
    [TestMethod]
    public void PacketSessionCheckFinalClassification2021IsCorrectPacketType()
    {
    ...
    /// </summary>
    [TestMethod]
    public void PacketSessionCheckFinalClassification2021IsFinalClassificationObject()
    {
