...
/// </summary>
[TestClass]
public class PacketParticipants2023Tests
{
    #region Fields
    ...
    {
        var isFile = File.Exists(@"SampleData/F1-2023-Participants.packet");

        if (isFile)
        {
            _packetAnalyzer = new PacketAnalyzer();

            _packetContent = File.ReadAllBytes(@"SampleData/F1-2023-Participants.packet");
        ...
        {
            Assert.IsTrue(isFile, "File F1-2023-Participants.packet is missing!");
        }
    }
    ...
    /// </summary>
    [TestMethod]
    public void PacketParticipantsCheckParticipants2023IsCorrectPacketType()
    {
    ...
    /// </summary>
    [TestMethod]
    public void PacketParticipantsCheckParticipants2023IsCorrectGameVersion()
    {
    ...
    /// </summary>
    [TestMethod]
    public void PacketParticipantsCheckParticipants2023IsParticipantsObject()
    {
        if (_packetData.PacketHeader != null && _packetContent?.Length >= ConstData.F12023ParticipantsSize + ConstData.F12023HeaderSize)
        {
            ...
            {
                isCorrect = data.PacketData is IParticipantsBase baseData && baseData.Participants is IParticipantData2023[];
            }
    ...
    /// <summary>
    /// Check active cars (2023)
    /// </summary>
    [TestMethod]
    public void PacketParticipantsActiveCars2023ExpectedValue()
    {
        if (_packetData.PacketHeader != null && _packetContent?.Length >= ConstData.F12023ParticipantsSize + ConstData.F12023HeaderSize)
        {
            var participants = _packetAnalyzer.GetParticipantsData(_packetData.PacketHeader, _packetContent);

            if (participants is Participants participantsData && participantsData.PacketData is IParticipantsBase baseData && baseData.Participants is IParticipantData2023[])
            {
    ...
    /// <summary>
    /// Check human controlled (2023)
    /// </summary>
    [TestMethod]
    public void PacketParticipantsIsHumanControlled2023ExpectedValue()
    {
        if (_packetData.PacketHeader != null && _packetContent?.Length >= ConstData.F12023ParticipantsSize + ConstData.F12023HeaderSize)
        {
            var participants = _packetAnalyzer.GetParticipantsData(_packetData.PacketHeader, _packetContent);
    ...
    /// <summary>
    /// Check driver name (2023)
    /// </summary>
    [TestMethod]
    public void PacketParticipantsDriverName2023ExpectedValue()
    {
        if (_packetData.PacketHeader != null && _packetContent?.Length >= ConstData.F12023ParticipantsSize + ConstData.F12023HeaderSize)
        {
            var participants = _packetAnalyzer.GetParticipantsData(_packetData.PacketHeader, _packetContent);
