...
/// </summary>
[TestClass]
public class PacketCarStatus2023Tests
{
    #region Fields
    ...
    {
        var isFile = File.Exists(@"SampleData/F1-2023-CarStatus.packet");

        if (isFile)
        {
            _packetAnalyzer = new PacketAnalyzer();

            _packetContent = File.ReadAllBytes(@"SampleData/F1-2023-CarStatus.packet");
        ...
        {
            Assert.IsTrue(isFile, "File F1-2023-CarStatus.packet is missing!");
        }
    }
    ...
    /// </summary>
    [TestMethod]
    public void PacketCarStatusCheckCarStatus2023IsCorrectPacketType()
    {
    ...
    /// </summary>
    [TestMethod]
    public void PacketCarStatusCheckCarStatus2023IsCorrectGameVersion()
    {
    ...
    /// </summary>
    [TestMethod]
    public void PacketCarStatusCheckCarStatus2023IsCarStatusDataObject()
    {
        if (_packetData.PacketHeader != null && _packetContent?.Length == ConstData.F12023CarStatusSize + ConstData.F12023HeaderSize)
        {
            var isCorrect = false;
            ...
            {
                isCorrect = packetData.PacketData is CarStatus2023;
            }
    ...
    /// <summary>
    /// Check fuel remaining laps (2023)
    /// </summary>
    [TestMethod]
    public void PacketCarStatusFuelRemainingLaps2023ExpectedValue()
    {
        if (_packetData.PacketHeader != null && _packetContent?.Length >= ConstData.F12023CarStatusSize + ConstData.F12023HeaderSize)
        {
            var carStatus = _packetAnalyzer.GetCarStatus(_packetData.PacketHeader, _packetContent);
            ...
            {
                Assert.Fail("Invalid car status format, expected F1 2023!");
            }
        }
        else
        {
    ...
    /// <summary>
    /// Check visual tyre compound (2023)
    /// </summary>
    [TestMethod]
    public void PacketCarStatusVisualTyreCompound2023ExpectedValue()
    {
        if (_packetData.PacketHeader != null && _packetContent?.Length >= ConstData.F12023CarStatusSize + ConstData.F12023HeaderSize)
        {
            var carStatus = _packetAnalyzer.GetCarStatus(_packetData.PacketHeader, _packetContent);
    ...
    /// <summary>
    /// Check ERS deployed this lap (2023)
    /// </summary>
    [TestMethod]
    public void PacketCarStatusERSDeployedThisLap2023ExpectedValue()
    {
        if (_packetData.PacketHeader != null && _packetContent?.Length >= ConstData.F12023CarStatusSize + ConstData.F12023HeaderSize)
        {
            var carStatus = _packetAnalyzer.GetCarStatus(_packetData.PacketHeader, _packetContent);
    ...
    /// <summary>
    /// Check fuel capacity (2023)
    /// </summary>
    [TestMethod]
    public void PacketCarStatusFuelCapacity2023ExpectedValue()
    {
        if (_packetData.PacketHeader != null && _packetContent?.Length >= ConstData.F12023CarStatusSize + ConstData.F12023HeaderSize)
        {
            var carStatus = _packetAnalyzer.GetCarStatus(_packetData.PacketHeader, _packetContent);
    ...
    /// <summary>
    /// Check engine max RPM (2023)
    /// </summary>
    [TestMethod]
    public void PacketCarStatusEngineMaxRpm2023ExpectedValue()
    {
        if (_packetData.PacketHeader != null && _packetContent?.Length >= ConstData.F12023CarStatusSize + ConstData.F12023HeaderSize)
        {
            var carStatus = _packetAnalyzer.GetCarStatus(_packetData.PacketHeader, _packetContent);
