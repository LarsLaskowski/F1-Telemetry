...
/// </summary>
[TestClass]
public class PacketLapData2020Tests
{
    #region Fields
    ...
    {
        var file = File.Exists(@"SampleData/F1-2020-LapData.packet");

        if (file)
        {
            _packetAnalyzer = new PacketAnalyzer();

            var fileContent = File.ReadAllBytes(@"SampleData/F1-2020-LapData.packet");
        ...
        {
            Assert.IsTrue(file, "File F1-2020-LapData.packet is missing!");
        }
    }
    ...
    /// </summary>
    [TestMethod]
    public void PacketLapDataCheckLapData2020IsCorrectPacketType()
    {
    ...
    /// </summary>
    [TestMethod]
    public void PacketLapDataCheckLapData2020IsCorrectGameVersion()
    {
