...
- [`docs/UNIT_TESTS.md`](docs/UNIT_TESTS.md) — binding test conventions for `F1Server.Tests`
  (naming, structure, assertions, what not to introduce). Follow it whenever adding or
  changing tests, in addition to the [Testing](#testing) section below.
