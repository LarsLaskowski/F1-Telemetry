...
/// <summary>
/// Session history lap data (F1 2021)
/// </summary>
public class SessionHistoryData2021 : ISessionHistoryDataBase
{
    #region Constructors
    ...
    /// Constructor
    /// </summary>
    public SessionHistoryData2021()
    {
        LapHistory = new SessionHistoryLapData2021[100];
        TyreStintHistory = new SessionHistoryTyreStintData2021[8];
    }
