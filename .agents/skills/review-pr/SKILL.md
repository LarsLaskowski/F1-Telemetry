...
- **AI-attribution check** — scan the PR title, body, and commit messages for "Codex", "OpenAI", "ChatGPT", "Claude", "Anthropic", "Copilot", "Generated with", "Generated by", "Co-Authored-By", `chatgpt.com`, `claude.ai`, or a session URL. `AGENTS.md` forbids all of these in PR title/body. Report any match as a **Blocking** finding with the exact text to remove.
