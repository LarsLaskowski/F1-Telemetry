                                     ...
                                     columns: table => new
                                                       {
                                                           ...
                                                           VirtualSafetyCarStages = table.Column<uint>(type: "int unsigned", nullable: false),
                                                           SafetyCarStages = table.Column<uint>(type: "int unsigned", nullable: false),
                                                           RedFlags = table.Column<uint>(type: "int unsigned", nullable: false)
                                                       },
                                     constraints: table =>
                                                  {
