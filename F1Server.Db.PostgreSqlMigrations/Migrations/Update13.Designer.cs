...
namespace F1Server.Db.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260223184752_Update13")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("F1Server.Db.Entity.Tables.UserEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ProviderKey", "Provider")
                        .IsUnique();

                    b.ToTable("Users", t =>
                        {
                            t.HasComment("Users table containing information about authenticated users from external identity providers.");
                        });
                });
